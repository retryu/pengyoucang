...
public class OprationDialog extends Dialog {
	...
	public void init(Context context) {
		...
		layoutAlert = (RelativeLayout) findViewById(R.id.Layout_Alert);
		setCancelable(true);

	}

	public void showDialog(FriendItem friendItem) {
		Log.e("debug", "" + friendItem);
		String number1 = null;
		String number2 = null;
		String name = null; 
	...
	public void bindCell1(final String number) {
		Button tvNumber = (Button) layoutCell1.findViewById(R.id.Tv_Number1);
		...
		tvNumber.setText(tvNumber.getText() + number);
	...
	public void bindCell2(final String number) {
		Button tvNumber = (Button) layoutCell2.findViewById(R.id.Tv_Number1);
		tvNumber.setText(tvNumber.getText() + number);
